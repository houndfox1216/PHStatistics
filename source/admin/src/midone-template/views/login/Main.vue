            ...
            <form @submit.prevent="formSubmit()">
              <div class="intro-x mt-8">
                ...
                <div class="input-group mt-4">
                  ...
                  />
                  <div id="input-group-captcha" class="border">
                    <img class="h-full border-0 rounded-r-lg" :src="captchaUrl" @click="data.captchaToken = uuid()" />
                  </div>
                </div>                
              </div>
              <div
...
<script setup>
import context, { reactive, computed, onMounted } from "@cloudfun/core";
