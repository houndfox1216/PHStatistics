...
| 135 | 百倍數總人數 | 分析(26) | 134 |
| 136 | 百世數學去年同期 | 分析(26) | 135 |
| 137 | 百倍數去年同期 | 分析(26) | 136 |
| 138 | PS上週人數 | 分析(26) | 137 |
| 139 | 百倍數上週人數 | 分析(26) | 138 |
| 140 | 本週PS新生人數 | 分析(26) | 139 |
| 141 | 本週PS流失人數 | 分析(26) | 140 |
| 142 | 本週變更(PS+百倍數) | 分析(26) | 141 |
| 143 | 本週總詢問人數 | 統計(13) | 142 |
| 144 | 總人數(PS+百倍數) | 統計(13) | 143 |
...
1. **課程144「總人數(PS+百倍數)」= 課程132「PS數學總人數」+ 課程135「百倍數總人數」**，跨校跨週資料完全吻合（例如47+8=55、34+2=36、35+2=37，查了學校12、19多週皆成立）。但**現行程式碼把132跟144當成同一個公式**（都只加總部門22/23/24，完全沒把135算進去）——這是一個既有 bug：如果這段程式碼真的被存檔觸發執行，144 會被錯誤覆蓋成跟132一樣的值，把百倍速的人數洗掉。這次遷移一併修正。
...
3. **課程142「本週變更(PS+百倍數)」= 本週144 − 上週144**（唯一可查資料：37−36=1，吻合）。
...
| 142 | 本週變更(PS+百倍數) | `DiffWithLastWeek`(10) | `[132,135]`（**SourceCourseIds**） | false |
| 144 | 總人數(PS+百倍數) | `SumBySourceCourses`(4) | `[132,135]`（**SourceCourseIds**） | false |
| 135 | 百倍數總人數 | `ManualInput`(50) | — | — |
| 136 | 百世數學去年同期 | `ManualInput`(50) | — | — |
| 137 | 百倍數去年同期 | `ManualInput`(50) | — | — |
| 139 | 百倍數上週人數 | `ManualInput`(50) | — | — |
