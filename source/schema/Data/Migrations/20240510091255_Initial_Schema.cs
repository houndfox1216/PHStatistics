    ...
    public partial class Initial_Schema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentPopulation", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataMode = table.Column<short>(type: "smallint", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    StudentPopulationId = table.Column<long>(type: "bigint", nullable: true),
                    ClassId = table.Column<int>(type: "int", nullable: true),
                    Number = table.Column<int>(type: "int", nullable: false),
                    Remark = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StudentPopulationId1 = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentPopulationItem", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentPopulationItem_Class_ClassId",
                        column: x => x.ClassId,
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.StudentPopulationId1,
                        principalTable: "StudentPopulation",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SchoolAssignment_Member_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Member",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SchoolAssignment_School_SchoolId",
                        column: x => x.SchoolId,
                        principalTable: "School",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SchoolAssignment_MemberId",
                table: "SchoolAssignment",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_SchoolAssignment_SchoolId",
                table: "SchoolAssignment",
                column: "SchoolId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentPopulationItem_ClassId",
                table: "StudentPopulationItem",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentPopulationItem_StudentPopulationId",
                table: "StudentPopulationItem",
