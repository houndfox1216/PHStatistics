...
/// </summary>
[JsonObject]
public class TaishinResponse<T> {
    /// <summary>
    /// 格式版本號
    /// 固定值:1.0.0
    /// </summary>
    ...
    /// 次特店代號
    /// </summary>
    [JsonProperty(PropertyName = "s_mid")]
    ...
    /// 交易回傳參數
    /// </summary>
    [JsonProperty(PropertyName = "params"), JsonRequired]
    ...
    public TaishinResponse(T param) => Parameters = param;
}