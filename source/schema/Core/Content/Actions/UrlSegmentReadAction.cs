...
namespace PHStatistics.Core.Content.Actions {
    ...
    public class UrlSegmentReadAction : ReadActionBase<UrlSegment, DataContext, SystemPermission> {
        ...
        public UrlSegmentReadAction(IUser user, DataContext dbContext = null, bool trackEnabled = false) : base("讀取網址區段資料", user, dbContext, trackEnabled) {
