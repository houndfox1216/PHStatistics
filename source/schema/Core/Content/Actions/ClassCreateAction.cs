...
/// </summary>
[Description("新增班系資料")]
public class ClassCreateAction : CreateActionBase<Class, DataContext, SystemPermission> {
    /// <summary>
    /// 必須具備的系統權限
    /// </summary>
    ...
    public ClassCreateAction(IUser user, DataContext context = null) : base("新增班系資料", user, context) {
        SetActionLog<ActionLogCommand<ActionLog, DataContext>>(context);
    }

    protected override void OnTransacting(DataContext context, Class data) {

    }

    protected override void OnCreating(DataContext context, Class data) {
