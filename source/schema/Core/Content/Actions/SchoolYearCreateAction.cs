...
/// </summary>
[Description("新增學年度資料")]
public class SchoolYearCreateAction : CreateActionBase<SchoolYear, DataContext, SystemPermission> {
    /// <summary>
    /// 必須具備的系統權限
    /// </summary>
    ...
    public SchoolYearCreateAction(IUser user, DataContext context = null) : base("新增學年度資料", user, context) {
        SetActionLog<ActionLogCommand<ActionLog, DataContext>>(context);
    }

    protected override void OnTransacting(DataContext context, SchoolYear data) {

    }

    protected override void OnCreating(DataContext context, SchoolYear data) {
