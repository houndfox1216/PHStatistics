...
/// </summary>
[Description("新增分校資料")]
public class SchoolCreateAction : CreateActionBase<School, DataContext, SystemPermission> {
    /// <summary>
    /// 必須具備的系統權限
    /// </summary>
    ...
    public SchoolCreateAction(IUser user, DataContext context = null) : base("新增分校資料", user, context) {
        SetActionLog<ActionLogCommand<ActionLog, DataContext>>(context);
    }

    protected override void OnTransacting(DataContext context, School data) {

    }

    protected override void OnCreating(DataContext context, School data) {
