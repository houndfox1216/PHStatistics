...
/// </summary>
[Description("新增人數表資料")]
public class StudentPopulationCreateAction : CreateActionBase<StudentPopulation, DataContext, SystemPermission> {
    /// <summary>
    /// 必須具備的系統權限
    /// </summary>
    ...
    public StudentPopulationCreateAction(IUser user, DataContext context = null) : base("新增人數表資料", user, context) {
        SetActionLog<ActionLogCommand<ActionLog, DataContext>>(context);
    }

    protected override void OnTransacting(DataContext context, StudentPopulation data) {

    }

    protected override void OnCreating(DataContext context, StudentPopulation data) {
