appsettings.json 參數說明
{
    "Cloudfun": {
        ...
        "Authentication": {
          ...
          "AccessDeniedRoute": "/Error/401", // 驗證失敗時的導向路由，預設為空
          "PasswordChangeRoute": "/Member/Profile", // 密碼變更時的導向路由，預設為空
          "ReturnUrlParameter": "returnUrl", // 身分驗證後返回網址之參數名稱，預設為 referer
          "PortalUser": { // 各種用戶可分開設定
            "AccessDeniedRoute": "/Error/401", // 驗證失敗時的導向路由，預設為空
            "PasswordChangeRoute": "/Member/ChangePassword", // 密碼變更時的導向路由，預設為空
            "ReturnUrlParameter": "returnUrl", // 身分驗證後返回網址之參數名稱，預設為 referer
          }
        },
        "Culture": {
