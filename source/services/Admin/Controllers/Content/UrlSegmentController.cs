...
public class UrlSegmentController : ApiController<ServiceUser, UrlSegmentModel, Culture> {
    /// <summary>
    /// 建構 UrlSegmentController
    /// </summary>
    public UrlSegmentController() : base("System") { }
    ...
    public JsonResponse Update(string values) {
        try {
            var data = values.FromJson<UrlSegment>();
